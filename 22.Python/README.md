...
* [Aula 5 — Arquivos e formatos](Python-Para-Engenheiros-Dados/aula_05_arquivos.ipynb)
* [Aula 6 — Mini-pipeline ETL](Python-Para-Engenheiros-Dados/aula_06_pipeline.ipynb)
